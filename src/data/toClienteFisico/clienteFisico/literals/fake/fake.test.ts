...
import { fakeIDUserFisico, fakeListUserFisicoArgsFAIL, fakeListUserFisicoArgsOK } from "../../../../toEntitys/clienteFisico/literals/fake/fake.ts";
...
Deno.test("[ fakeOK_two ]deve retornar as props com os valores  corretos utilizados no fake", () => {
  const { sutOk } = makeSut();
...
Deno.test("[ fakeFAIL_one ]deve retornar as props com os valores  corretos utilizados no fake", () => {
...
Deno.test("[ fakeFAIL_two ]deve retornar as props com os valores  corretos utilizados no fake", () => {
  const { sutFAIL } = makeSut();
